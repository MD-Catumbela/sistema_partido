                        ...
                        <div class="card card-outline card-default">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="create.php" class="btn btn-default"><i class="fas fa-layer-group"></i> Adicionar</a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($dados_cap as $dado_cap) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%;"><?= $dado_cap['cap']; ?></td>
                                                <td style="width: 25%;"><?= $dado_cap['cas']; ?></td>
                                                <td style="width: 40%;"><?= $dado_cap['descricao_cap']; ?></td>
                                                <td style="width: 10%; text-align: center;">
                                                    <div class="btn-group">
                                                        <a href="update.php?id=<?= $id_cap; ?>" class="btn btn-default btn-sm mr-1"><i class="fas fa-edit"></i></a>
                                                        <a href="javascript:void(0);" class="btn btn-default btn-sm" onclick="confirmDelete('<?= APP_URL; ?>/app/controllers/cap/delete.php?id=<?= $id_cap; ?>')">
