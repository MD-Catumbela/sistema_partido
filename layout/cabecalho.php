    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= APP_URL; ?>" class="brand-link">
                <img src="<?= APP_URL; ?>/public/img/empresa.jpeg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <!-- USUÁRIO -->
                        <li class="nav-item">
                            <a href="<?= APP_URL; ?>/usuarios" class="nav-link active bg-warning text-white">
                        ...
                        <!-- COMITES -->
                        <li class="nav-item">
                            <a href="<?= APP_URL; ?>/comites" class="nav-link active bg-warning text-white">
                        ...
                        <!-- FUNCÕES -->
                        <li class="nav-item">
                            <a href="<?= APP_URL; ?>/cargos" class="nav-link active bg-warning text-white">
                        ...
                        <!-- SECTORES -->
                        <li class="nav-item">
                            <a href="<?= APP_URL; ?>/cas" class="nav-link active bg-warning text-white">
                        ...
                        <!-- CAP -->
                        <li class="nav-item">
                            <a href="<?= APP_URL; ?>/cap" class="nav-link active bg-warning text-white">
                        ...
                        <!-- MILITANTES -->
                        <li class="nav-item">
                            <a href="<?= APP_URL; ?>/militantes" class="nav-link active bg-warning text-white">
