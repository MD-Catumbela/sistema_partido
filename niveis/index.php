                        ...
                        <div class="card card-outline card-default">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="create.php" class="btn btn-default"><i class="fas fa-user-tag"></i> Adicionar</a>
                                </div>
                            </div>
                                        ...
                                        foreach ($dados_niveis as $dado_nivel) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 10%; text-align: center;">
                                                    <div class="btn-group">
                                                        <a href="update.php?id=<?= $id_nivel; ?>" class="btn btn-default btn-sm mr-1"><i class="fas fa-edit"></i></a>
                                                        <a href="javascript:void(0);" class="btn btn-default btn-sm" onclick="confirmDelete('<?= APP_URL; ?>/app/controllers/niveis/delete.php?id=<?= $id_nivel; ?>')">
